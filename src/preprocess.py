...
def main(datafile, out):
    ...
    movies.loc[movies.id == 15417, 'budget'] = movies.loc[movies.id == 15417, 'budget'] * 1000000
    movies.loc[movies.id == 15417, 'revenue'] = movies.loc[movies.id == 15417, 'revenue'] * 1000000

    movies.loc[movies.id == 16340, 'budget'] = movies.loc[movies.id == 16340, 'budget'] * 1000000
    movies.loc[movies.id == 16340, 'revenue'] = movies.loc[movies.id == 16340, 'revenue'] * 1000000
